...
from app.core.ccxtbt.ccxtstore import CCXTStore
...
class TestStrategy(bt.Strategy):
    ...
    def next(self):
        ...
        for data in self.datas:
            print('{} - {} | USDT Cash {} | O: {} H: {} L: {} C: {} V:{} SMA:{}'.format(data.datetime.datetime(),
...
# Create our store
config = {'apiKey': Config.ccxt_api_key(),
          'secret': Config.cctx_secret(),
